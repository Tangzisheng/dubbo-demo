package net.sendcloud.dubbo.configuration;
 ...
 */
@Configuration
@EnableDubbo(scanBasePackages = "net.sendcloud.dubbo.Annotation")
@ComponentScan(value = {"net.sendcloud.dubbo.Annotation"})
